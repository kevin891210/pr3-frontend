...
import { 
  ...
  Sun, Moon, Coffee, Home, Smartphone, Zap
} from 'lucide-react';
      ...
      <div className={styles.dashboardContainer}>
        <div className="flex items-center justify-center min-h-screen">
          <div className="text-center">
            <div className={`${styles.loadingSpinner} w-12 h-12 border-4 rounded-full mx-auto mb-4`}></div>
    ...
    <div className={styles.dashboardContainer}>
          ...
          <div className="flex justify-between items-center h-16 sm:h-20">
            <div className="flex items-center space-x-4">
              <div className="flex items-center space-x-3">
                <div className={`${styles.logoContainer} w-10 h-10 sm:w-12 sm:h-12 rounded-full flex items-center justify-center`}>
                  <User className="w-5 h-5 sm:w-6 sm:h-6 text-white" />
                </div>
                <div>
                  <h1 className={`${styles.greetingText} text-xl sm:text-2xl font-bold`}>
                    Agent Portal
                  </h1>
      ...
      <main className="px-4 sm:px-6 py-6 sm:py-8 relative z-10">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          <Card className={`${styles.statsCard} ${styles.blueGradient} text-white border-0`}>
          ...
          <Card className={`${styles.statsCard} ${styles.greenGradient} text-white border-0`}>
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <div>
          ...
          <Card className={`${styles.statsCard} ${styles.purpleGradient} text-white border-0`}>
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <div>
          ...
          <Card className={`${styles.statsCard} ${styles.orangeGradient} text-white border-0`}>
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <div>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
          ...
          <div className="xl:col-span-2">
            <Card className={`${styles.glassCard} border-0`}>
              <CardHeader className="pb-4">
                <CardTitle className="flex items-center gap-3 text-xl font-bold text-gray-800">
                  <div className={`${styles.iconContainer} ${styles.blueIcon} w-10 h-10 rounded-lg flex items-center justify-center`}>
          ...
          <div className="space-y-6">
            ...
            <Card className={`${styles.glassCard} border-0`}>
              <CardHeader className="pb-4">
                <CardTitle className="flex items-center gap-3 text-lg font-bold text-gray-800">
                  <div className={`${styles.iconContainer} ${styles.greenIcon} w-8 h-8 rounded-lg flex items-center justify-center`}>
              ...
              <CardContent className="space-y-3">
                <Button 
                  className={`${styles.actionButton} w-full text-white border-0`}
                ...
                {Array.isArray(leaveBalance) && leaveBalance.length > 0 ? (
                  <div className="space-y-3">
                    {leaveBalance
                      ...
                      .map((balance) => (
                        <div key={balance.id} className={`${styles.leaveBalanceCard} p-4 rounded-xl`}>
            ...
            <Card className={`${styles.glassCard} border-0`}>
              <CardHeader className="pb-4">
                <CardTitle className="flex items-center gap-3 text-lg font-bold text-gray-800">
                  <div className={`${styles.iconContainer} ${styles.purpleIcon} w-8 h-8 rounded-lg flex items-center justify-center`}>
            ...
            <Card className={`${styles.glassCard} border-0`}>
              <CardHeader className="pb-4">
                <CardTitle className="flex items-center gap-3 text-lg font-bold text-gray-800">
                  <div className={`${styles.iconContainer} ${styles.orangeIcon} w-8 h-8 rounded-lg flex items-center justify-center`}>
                ...
                {Array.isArray(notices) && notices.length > 0 ? (
                  <div className="space-y-3">
                    {notices.slice(0, 3).map((notice, index) => (
                      <div key={index} className={`${styles.requestCard} p-4 rounded-xl`}>
...
export default AgentDashboardFinal;